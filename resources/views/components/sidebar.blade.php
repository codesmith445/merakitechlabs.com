<aside class="w-full md:w-1/3 flex flex-col items-center px-3">
  ...
  <div class="w-full bg-white shadow flex flex-col my-4 p-6">
    <img class="w-32 h-32 rounded-full mx-auto" src="{{ \App\Models\TextWidget::getImage('about-us-sidebar') ?? 'default-image.jpg' }}" alt="about us sidebar image">
    <div class="text-sm mt-5">
        <a href="#" class="font-bold leading-none text-gray-900 hover:text-indigo-600 transition duration-500 ease-in-out">Cristian
            Quiñones
        </a>
        <p class="font-bold">Innovator, Author &amp; Hobbyist</p>
    </div>

    <p class="mt-2 text-sm text-gray-900">{!! \App\Models\TextWidget::getContent('about-us-sidebar') !!}</p>
    ...
    <div class="flex mt-4 justify-center">
        ...
        <a href="https://web.facebook.com/profile.php?id=100084707313756" target="_blank" class="w-6 mx-1">
            <svg class="fill-current cursor-pointer text-gray-500 hover:text-indigo-600" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule: evenodd; clip-rule: evenodd; stroke-linejoin: round; stroke-miterlimit: 2;">
        ...
        <a href="https://www.youtube.com/@merakitechlabs" target="_blank" class="w-6 mx-1">
            <svg class="fill-current cursor-pointer text-gray-500 hover:text-indigo-600" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule: evenodd; clip-rule: evenodd; stroke-linejoin: round; stroke-miterlimit: 2;">
                <g id="Layer_1">
