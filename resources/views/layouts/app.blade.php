...
<head>
    ...
    <title>{{ $metaTitle ?: 'merakitechlabs' }}</title>
...
<body class="bg-gray-70 font-family-karla">
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center py-12">
            <a class="font-bold text-yellow-800 uppercase hover:text-gray-700 text-5xl" href="{{ route('home') }}">
                merakitechlabs
            </a>
    ...
    <!-- Topic Nav -->
    <nav class="w-full py-4 border-t border-b bg-gray-900" x-data="{ open: false }">
