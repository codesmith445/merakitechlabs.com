...
<html lang="en">
  <head>
    ...
    <title>@yield('title', 'Hotspot Login')</title>
  ...
  @include('admin-layouts.admin-header')
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ggbfA3WxL3IFV5vew2B8vpo/dWLNYdW4TbhdxC+Bc/HX1jSQU3NCUuYZYLW/F5RI" crossorigin="anonymous"></script>
